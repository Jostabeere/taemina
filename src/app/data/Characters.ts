...
export const characters: Character[] = [
  {
    ...
    birthday: '6. Mai',
    citation:
      'Ob ich Ärger bekomme, ist mir ehrlich gesagt ziemlich egal. Euch würde ich auch nicht einfach in einer Zelle versauern lassen.',
    meanings: [
      {
        property: 'Vorname',
        translation: 'Sonne',
    ...
    skills: [
      {
        ...
        strength: '0',
        description:
          'Eine praktische, schwebende Lichtkugel an ihrer Seite, die auch als Nachtlicht verwendet werden kann.',
      ...
      },
      {
        ...
        strength: '0',
        description:
          'Ein Unsichtbarkeitszauber, der die Lichtbrechung um sie herum verändert.',
        category: [MagicType.light],
      },
      {
        ...
        strength: '0',
        description:
          'Durch Lichtbrechung erschafft sie eine Art Spiegel, durch den der Gegner abgelenkt wird. Aus den Spiegeln kann sie außerdem Lichtkugeln als Massenangriff schließen.',
    ...
    problem:
      'Rückschläge nagen schnell an ihrem Selbstvertrauen. Dann plagen sie Selbstzweifel und sie schottet sich ab.',
    development:
      'Sie muss lernen, selbstbewusster zu werden und mehr an sich zu glauben.',
    fears: ['Versagen', 'Dunkelheit'],
    description:
      'Sora ist unsere willensstarke Protagonistin. Normalerweise ist sie anderen gegenüber aufgeschlossen, manchmal sogar fast schon zu vertrauensselig. Sie findet schnell Freunde, aber lässt sich auch leicht verunsichern. ' +
      'Ihre Lieblingsfächer sind Magische Bande gefolgt von Telepathie. Sie hat schon seit sie denken kann Angst im Dunkeln. Ihre Lieblingspflanze ist die Lunaluxblume.',
    pets: [
      {
        name: 'Azrael',
        description:
          'In ihrer Kette ist ein ist magischer Beschützer in Form einer Schimmereule. Wird mit einem speziellen Zauber lebendig.',
        icon: 'pets',
  ...
  },
  {
    ...
    looks: {
      ...
      accessory:
        'Er trägt einen Oberarmreif, der sich perfekt, in ein Tattoo einfügt.',
      body: '185 cm groß, sportlich, riecht ein bisschen nach Büchern, Leder und Zedernholz',
    },
    ...
    mbti: 'INTP',
    past: 'Sohn von Lumiel Finsterfaust. Sein Großvater (Vater seiner Mutter) ging als der mächtigste, aber auch wahnsinnigste Schattenmagier in die Geschichte ein. Adryans Eltern sind keine Schattenmagier und fürchten sich vor seinen Fähigkeiten.',
    problem: 'Höhenangst, Engstirnigkeit.',
    description:
      'Adryan spricht fließend Mahoa und versteht daher auch den Inhalt von Zaubersprüchen.',
    fears: ['Höhen', 'Andere zu verletzen'],
    image: 'assets/img/character/adryan.jpg',
    development:
      'Durch die Macht der Freundschaft taut Adryan nach und nach auf.',
    pets: [
      {
        name: 'Baghira',
        description:
          'Ein dicker Katzenfamiliar, der meistens noch schlechtere Laune hat als sein Besitzer.',
  ...
  },
  {
    ...
    lastName: 'Metzeldes',
    citation:
      'Da drehte sich die Insel und dann hab ich eben irgendwas gemacht.',
    meanings: [],
    ...
    skills: [
      {
        ...
        strength: '1',
        description:
          'Dem Ziel des Zaubernden gelingt plötzlich alles viel wahrscheinlicher.',
    ...
    looks: {
      hairColor: {
        color: '#d5c3b0',
        description:
          'Silberblonde, meistens zu zwei Schwänzchen zusammengebundene Haare',
      },
      eyeColor: {
        color: '#b5dbe9',
    ...
    problem:
      'Die Männerwelt stellt für Valda eine große Motivation dar. Sie hat jede Woche einen neuen Schwarm. Aber sie kann auch teilen: Wenn Adryan schon nicht zu ihr gehören will, soll wenigstens Sora ihn haben.',
    description:
      'Heimliche Heldin. Sabotiert durch Tollpatschigkeit bzw. versteckte Glücksmagie Halonas Ranschmeißversuche. Unterstützt Ship Halona und Adryan nicht!',
  },
  {
    ...
    skills: [
      {
        ...
        strength: '6',
        description:
          'Lässt kleine hungrige Pflanzen spießen, die Feinde beißen.',
    ...
    looks: {
      ...
      accessory: '',
      body: '174cm groß mit auffälliger Tätowierung am Hals',
    },
    ...
    past:
      'Ivys Eltern haben sie liebevoll in einem kleinen Dorf im Magierreich großgezogenn. ' +
      'Sie hat keinen Familiar, da sie im Insektenmonat geboren ist. Sie hat einen älteren Bruder, der ebenfalls Pflanzen mag.',
    description:
      'Ivy ist eine Pflanzenmagierin und hat als solche eine besondere Beziehung zu Pflanzen, insbesondere gefallen ihr Kakteen und fleischfressende Pflanzen. Für Tiere oder Insekten hat sie hingegen nicht viel übrig.' +
  ...
  },
  {
    ...
    description:
      'Die Luftmagierin Thea ist eine sanftmütige, empathische Person. Sie ist Soras Mitbewohnerin und sie verbindet ein freundschaftliches Verhältnis. Sie und Ivy scheinen unzertrennlich. In ihrer Freizeit stellt sie gerne gedankengewebte Kleidung her.',
    skills: [
      {
        name: 'Elektroschock',
        strength: '6',
    ...
    loveInterests: [
      {
        ...
        interest: 1,
        notes: 'Wir werden es nie herausfinden!',
      },
    ],
    looks: {
      hairColor: {
  ...
  },
  {
    ...
    looks: {
      ...
      eyeColor: {
        color: '#0b1860',
        description:
          'dunkelblaue, spitz zulaufende Augen. Durchdringender Blick.',
      },
    ...
    pets: [
      {
        name: 'Krähe',
        description:
          'Ein vernachlässigter, unglücklicher Familiar, der in ihrer Haarspange haust.',
        icon: 'pets',
  ...
  },
  {
    ...
    magic: MagicType.light,
    classes: ['Lichtmagie', 'Heilmagie', 'Trankkunde'],
    mbti: 'INFJ',
    ...
    problem:
      'Sehr kranke Mutter, die er mit seinen Fähigkeiten unbedingt retten möchte.',
    fears: ['Verlust', 'Scham'],
    description:
      'Lior ist eine sanfte Seele, der immer freundlich zu jedem ist. Dabei bleibt er aber stets oberflächlich. ' +
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        strength: '1',
        description:
          'Ein nützlicher Zauber, der den Anwender für kurze Zeit klein werden lässt.',
        category: [MagicType.shape],
      },
    ],
    traits: [
      {
    ...
    looks: {
      ...
      body: '183 cm groß, trainiert, riecht nach Zimt, Asche, Heu',
    },
    magic: MagicType.fire,
    classes: ['Feuermagie', 'Metamorphose', 'Kemu'],
    mbti: 'ENTJ',
    past: 'Sohn von Jeldrik und Saphira von Las Marmotas.',
    description:
      'Als Prinz des Magiereichs ist Albert bestens ausgebildet. Seine magischen Fähigkeiten, sein diplomatisches Geschick, seine Fähigkeit, Probleme schnell und pragmatisch zu lösen und seine Empathie machen ihn zu einem würdigen Anwärter auf den Thron.',
    problem:
      'Er steht starr zu seinen Werten und er hat Schwierigkeiten im Umgang mit Veränderung.',
    fears: ['Erwartungen nicht gerecht zu werden', 'Abweisung'],
    pets: [
      {
        name: 'Arget',
        description:
          'Ein junger Drachenfamiliar, der in einem langen Ohrring sitzt.',
        icon: 'pets',
  ...
  },
  {
    ...
    description:
      'Er ist eine sehr oberflächliche Person, die andere nach ihrem Aussehen, Ruf und ihrer Macht bewertet. Eine Person näher kennenzulernen, hält er für unnötig.',
    meanings: [],
    ...
    skills: [
      {
        ...
        strength: '0',
        description:
          'Vorhersage bald erfolgender Ereignisse mit moderater Korrektheit.',
    ...
    problem:
      'Er möchte seitdem Rache nehmen. Er möchte Macht und selbst König sein.',
    development: '',
  },
  {
  ...
  },
  {
    ...
    description:
      'Elea ist ebenso schön wie beliebt. Sie spricht eher wenig und leise. Über den neuesten Klatsch und Tratsch ist sie immer bestens informiert.',
    problem:
      'Ihre Beliebtheit hat ihren Preis. Sie ist umringt von falschen Freunden und aufgrund vergangener Erfahrungen verhält sie sich kühl und abweisend.',
    meanings: [
      {
        property: 'Vorname',
    ...
    skills: [
      {
        ...
        strength: '8',
        description:
          'Erschafft spitze, kleine Eispfeile, die sie auf Feinde schießen kann.',
        category: [MagicType.water],
      },
      {
        name: 'Frisieren',
        strength: '0',
        description:
          'Sie hat die Haare schön. So eine Mähne muss schließlich richtig liegen.',
        category: [MagicType.air, MagicType.water, MagicType.enhancement],
      },
    ],
    traits: [
  ...
  },
  {
    ...
    looks: {
      hairColor: {
        color: '#251807',
        description:
          'Zwei lange, dunkelbraune Zöpfe, die als Seilknoten geflochten wurden mit Seitenpony',
      },
      eyeColor: {
        color: '#632c00',
    ...
    skills: [
      {
        ...
        category: [MagicType.water, MagicType.water],
      },
    ],
    traits: [
      {
  ...
  },
  {
    ...
    lastName: 'Hidayat',
    citation:
      'Und jetzt lass mich runter, ich hab mit dem da noch ein Hühnchen zu rupfen.',
    ...
    skills: [
      ...
      },
      {
        ...
        strength: '1',
        description:
          'Macht eine ausgewählte lörperliche Fertigkeit schneller und / oder stärker.',
        category: [MagicType.enhancement],
      },
    ],
    traits: [
  ...
  },
  {
    ...
    problem:
      'Steht oft im Schatten anderer. Kümmert sich sehr darum, was andere von ihr halten.',
    fears: ['Kritik'],
    description: '',
    pets: [],
  },
  {
    ...
    lastName: 'Fenris',
    citation:
      'Ihr könnt anderen Menschen helfen, aber nur, wenn ihr bereit seid, viel zu lernen.',
  ...
  },
  {
    ...
    looks: {
      hairColor: {
        color: '#4b2d11',
        description:
          'braune, wilde, kinnlange Locken mit grauen Strähnen durchzogen',
      },
      eyeColor: {
        color: '#281a10',
    ...
    magic: MagicType.water,
    classes: ['Wassermagie', 'Floramagie', 'Magische Pflanzen'],
  ...
  },
  {
    ...
    looks: {
      hairColor: {
        color: '#5a264aff',
        description: 'Pixiecut, dunkelviolett',
      },
      eyeColor: {
        color: '#d7a80f',
        description: 'goldene Augen',
      },
      face: 'Ungewöhnliche Gesichtsform, leicht gelbliche Haut und leichte Stirnfalten',
    },
    magic: MagicType.earth,
    classes: ['Erdmagie', 'Zaubersprüche'],
    description: 'Manahune im Rat der Drei',
  },
  {
    ...
    magic: MagicType.air,
    classes: ['Luftmagie', 'Magische Bande', 'Portale', 'Trankkunde'],
  ...
  },
  {
    ...
    magic: MagicType.shadow,
    description:
      "Er ist der Autor des Buchs 'Über die Grenzen der Magie hinaus'. Seine Tochter ist Adryans Mutter.",
    past:
      'Hat mächtigen Kristall geklaut, der einen gigantischen Magievorrat enthält und diesen angeblich zerstört. ' +
  ...
  },
  {
    ...
    magic: MagicType.air,
    description:
      'Soras Vater. Ihm wird nachgesagt, eine besondere Bindung zu Tieren zu haben.',
  },
  {
  ...
  },
  {
    ...
    magic: MagicType.earth,
    description:
      'Ein ungewöhnlicher Magierjäger, der die anderen Manahunen aus dem Rat zu kennen scheint.',
  ...
  },
  {
    ...
    description:
      'Kai ist ein sturer Mensch, der lange in der Armee gedient und sich dort einen Namen gemacht hat.',
    fears: ['Schuld', 'als schlechter Mensch angesehen zu werden'],
  },
  {
    characterType: CharacterType.knoblauch,
    name: 'Sarka',
    ...
    description:
      "Eine ehrgeizige Magierin des zweithöchsten Rangs 'Manata', die um jeden Preis zur Manahune werden will.",
    fears: ['es zu nichts bringen'],
    magic: MagicType.light,
  },
  {
    characterType: CharacterType.kaya,
    name: 'Kaya',
    lastName: 'Adair',
    age: 'unbekannt',
    image: 'assets/img/character/kaya.jpg',
    meanings: [
      {
        property: 'Vorname',
        translation: 'die große Schwester',
        language: 'hopi-indianisch',
      },
      {
        property: 'Nachname',
        translation: 'Bewohner des Eichenwalds',
    ...
    skills: [
      {
        name: 'Niedere Dämonen beschwören',
        strength: '3',
        description: 'Beschwört und kontrolliert einige niedere Dämonen.',
        category: [MagicType.shape],
      },
      {
        name: 'Hungerteufel beschwören',
        strength: '6',
        description:
          'Beschwört und kontrolliert einen wilden, starken Dämonen.',
        category: [MagicType.shape],
      },
      {
        name: 'Albtraumfresser beschwören',
        strength: '10',
        description:
          'Beschwört und kontrolliert einen gefährlichen, raubtierartigen Dämonen.',
        category: [MagicType.shape],
      },
    ],
    traits: [],
    looks: {
      hairColor: {
        color: '#143d1f',
        description: 'dunkelgrünes, langes glattes Haar mit Pony',
      },
      eyeColor: {
        color: '#6e3208',
        description: 'rotbraune Augen',
      },
    },
    description:
      'Kaya ist die ältere Schwester von Erlen Adair. Sie war schon immer gut darin, andere zu belügen und zu täuschen. Dabei hilft ihr ihr Improvisationstalent. Sie ist deutlich stiller als ihr Bruder, aber genauso machthungrig. Hin und wieder zeigt sie auch eine selbstgerechte und gnadenlose Seite. Ihrer Familie gegenüber ist sie loyal und fürsoglich, für ihre Feinde ist sie jedoch eine furchtlose Kämpferin.',
    development:
      'Nach Erlens Tod ist Kaya entschlossen, seinen Tod zu rächen. Sie ist eine Schlüsselfigur der Mateg und eine wahre Anführerin. Da ihre Familie aus historischen Gründen diskriminiert wird, ist sie ein Feind der Magiergesellschaft.',
    fears: ['ohne Leistung nichts wert zu sein'],
    magic: MagicType.shape,
  },
];
